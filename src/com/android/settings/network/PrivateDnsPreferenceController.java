        ...
        switch (mode) {
            ...
            case PRIVATE_DNS_MODE_PROVIDER_HOSTNAME:
                ...
                if (privateDnsHostname.equals(cloudflareHostname)) {
                    ...
                    return res.getString(R.string.private_dns_mode_cloudflare_block_malware);
                } else if (privateDnsHostname.equals(cloudflareblockmalwaresndsdultcontentHostname)) {
                    return res.getString(R.string.private_dns_mode_cloudflare_block_malware_and_adult_content);
                    ...
                    return res.getString(R.string.private_dns_mode_quad9_unsecured);
